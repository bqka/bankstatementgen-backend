...
public final class AxisTransactionRenderer {
    ...
    public AxisTransactionRenderer(Statement stmt) {
        this.stmt = stmt;
    ...
    public void render(Document doc, PdfWriter writer, Fonts fonts) {
        ...
        float y3 = drawFooterAtY(doc, cb, fonts, footer + 2f, stmt.details.branchAddress,
        stmt.details.branchPhoneNo);
        if(!pageBreak){
            y3 = drawLegendAxisStyle(doc, cb, fonts, y + MOVE_UP);
        }
    ...
    private void drawTransactionTotalRow(
        ...
        drawRightAligned(cb, f, 10, 443.94f, y + 2, credit);
    ...
    private float drawFooterAtY(
        ...
        BaseFont font = fonts.timesRoman.getBaseFont();
        ...
        for (String para : FOOTER_PARAGRAPHS) {
            ...
            for (String line : lines) {
                ...
                if (y < FOOTER_BOTTOM_MARGIN) {
                    ...
                    pageBreak = true;
                    ret = drawLegendAxisStyle(doc, cb, fonts, startY + 580f);
